          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="relative h-14">
              <input
                ...
                className="absolute inset-0 w-full bg-[#333] text-white rounded px-4 pt-5 pb-1 text-base outline-none focus:ring-2 focus:ring-white/30 transition-all autofill:bg-[#333]"
              />
              <label
                htmlFor="email"
