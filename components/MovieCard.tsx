        ...
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end rounded-xl overflow-hidden">
          <div className="bg-gradient-to-t from-black via-black/80 to-transparent p-3">
            ...
            <div className="flex items-center gap-2 mt-2">
              <button className="bg-white text-black rounded-full w-7 h-7 flex items-center justify-center text-xs font-bold hover:bg-gray-200 transition-colors">
                ▶
              </button>
              <button className="border border-gray-400 text-white rounded-full w-7 h-7 flex items-center justify-center text-sm hover:border-white transition-colors">
                +
              </button>
            </div>
          </div>
